    ...
    return (
        addNewCard ? (
            <div className="add-new-card add-new-card--active">
                <input ref={(input) => input && input.focus()} value={newCardName} onChange={(e) => handleNewCardName(e)} className="add-new-card__input" type="text" placeholder="Enter a title for this card..." autoComplete="off" />
